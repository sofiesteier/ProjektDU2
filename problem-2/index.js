...
create_levels_subjects_languages_filters("level", LEVELS);
create_levels_subjects_languages_filters("subject", SUBJECTS);
create_levels_subjects_languages_filters("language", LANGUAGES);
